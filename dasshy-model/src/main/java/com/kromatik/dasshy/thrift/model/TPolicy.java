...
public class TPolicy implements org.apache.thrift.TBase<TPolicy, TPolicy._Fields>, java.io.Serializable, Cloneable, Comparable<TPolicy> {
  ...
  private TExtractor extractor; // required
  private TTransformer transformer; // required
  private TLoader loader; // required
  ...
  private static final int __LASTUPDATED_ISSET_ID = 1;
  ...
  static {
    ...
    tmpMap.put(_Fields.EXTRACTOR, new org.apache.thrift.meta_data.FieldMetaData("extractor", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TExtractor.class)));
    tmpMap.put(_Fields.TRANSFORMER, new org.apache.thrift.meta_data.FieldMetaData("transformer", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TTransformer.class)));
    tmpMap.put(_Fields.LOADER, new org.apache.thrift.meta_data.FieldMetaData("loader", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TLoader.class)));
  ...
  public TPolicy(TPolicy other) {
    ...
    if (other.isSetExtractor()) {
      this.extractor = new TExtractor(other.extractor);
    }
    if (other.isSetTransformer()) {
      this.transformer = new TTransformer(other.transformer);
    }
    if (other.isSetLoader()) {
      this.loader = new TLoader(other.loader);
    }
    if (other.isSetState()) {
  ...
  public TExtractor getExtractor() {
    return this.extractor;
  }

  public void setExtractor(TExtractor extractor) {
    this.extractor = extractor;
  }
  ...
  public void setTransformer(TTransformer transformer) {
    this.transformer = transformer;
  }
  ...
  public TLoader getLoader() {
    return this.loader;
  }

  public void setLoader(TLoader loader) {
    this.loader = loader;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TRANSFORMER:
      if (value == null) {
        ...
        setTransformer((TTransformer)value);
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 5: // EXTRACTOR
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.extractor = new TExtractor();
          ...
          case 6: // TRANSFORMER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.transformer = new TTransformer();
